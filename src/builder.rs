...
pub struct InterchainPayloadBuilder<EvmConfig> {
...
impl<EvmConfig> InterchainPayloadBuilder<EvmConfig> {
...
impl<Pool, Client, EvmConfig> PayloadBuilder<Pool, Client> for InterchainPayloadBuilder<EvmConfig>
where
